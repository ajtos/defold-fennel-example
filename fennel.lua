-- Hacky version of fennel.lua 0.10 for use with Defold
-- In Defold package.loaders is just a single function.
-- We need to create our own loader, otherwise Defold won't look into package.preload populated by Fennel
table.insert(package.loaders, 1, function(modname) return package.preload[modname] end)

-- require() calls looking like pointing to files where changed to _G.require() so Defold bob won't pick those as dependencies
-- via https://forum.defold.com/t/the-module-socket-lua-cant-be-found-during-bundle-solved/65152
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  local utils = _G.require("fennel.utils")
  local parser = _G.require("fennel.parser")
  local compiler = _G.require("fennel.compiler")
  local specials = _G.require("fennel.specials")
...
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  local utils = _G.require("fennel.utils")
  local view = _G.require("fennel.view")
  local parser = _G.require("fennel.parser")
  local compiler = _G.require("fennel.compiler")
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  local utils = _G.require("fennel.utils")
  local parser = _G.require("fennel.parser")
  local friend = _G.require("fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
utils = _G.require("fennel.utils")
local parser = _G.require("fennel.parser")
local compiler = _G.require("fennel.compiler")
local specials = _G.require("fennel.specials")
local repl = _G.require("fennel.repl")
local view = _G.require("fennel.view")
